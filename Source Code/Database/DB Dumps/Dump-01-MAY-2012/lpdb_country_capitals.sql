...
DROP TABLE IF EXISTS `country_capitals`;
...
CREATE TABLE `country_capitals` (
  ...
  `capital_type` int(11) DEFAULT NULL,
...
LOCK TABLES `country_capitals` WRITE;
/*!40000 ALTER TABLE `country_capitals` DISABLE KEYS */;
/*!40000 ALTER TABLE `country_capitals` ENABLE KEYS */;
UNLOCK TABLES;
